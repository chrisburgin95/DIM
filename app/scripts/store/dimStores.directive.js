  ...
  function Stores() {
    return {
      ...
      template: [
        ...
        '    </div>',
        '  </div>',
        '  <div ng-click="vm.toggleSection(category)" ng-repeat="(category, buckets) in ::vm.buckets.byCategory track by category" class="section" ng-class="::category | lowercase">',
        '    <div class="title">',
